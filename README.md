...
df=pd.read_csv('/content/weatherimportAUS.csv', encoding='utf-8')
...
def probs(data, child, parent1=None, parent2=None):
    if parent1==None:
        ...
        prob=pd.crosstab(data[child], 'Empty', margins=False, normalize=
'columns').sort_index().to_numpy().reshape(-1).tolist()
    elif parent1!=None:
...
```
## Output:
![image](https://github.com/user-attachments/assets/ddd602fa-1130-4bbe-9781-6faa3ff43df9)
![image](https://github.com/user-attachments/assets/dd2b8c4a-cf77-4d38-bcad-ef130b9c2cf4)
![image](https://github.com/user-attachments/assets/e7e8ea40-f8da-44e3-80a9-fe98d1e96920)
